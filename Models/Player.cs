...
namespace DraftAdmin.Models
{
    public class Player : ModelBase
    {
        ...
        {
            get { return _tvName; }
            set { _tvName = value; OnPropertyChanged("TvName"); }
        }
        ...
        public string Hometown
        {
            ...
            set { _hometown = value; OnPropertyChanged("Hometown"); }
        }
        ...
        public string Headshot
        {
            ...
            set { _headshot = value; OnPropertyChanged("Headshot"); }
        }
        ...
        public string TradeTidbit
        {
            ...
            set { _tradeTidbit = value; OnPropertyChanged("TradeTidbit"); }
        }

        public int KiperRank
        {
            get { return _kiperRank; }
            set { _kiperRank = value; OnPropertyChanged("KiperRank"); }
        }

        public int McShayRank
        {
            get { return _mcshayRank; }
            set { _mcshayRank = value; OnPropertyChanged("McShayRank"); }
        }
